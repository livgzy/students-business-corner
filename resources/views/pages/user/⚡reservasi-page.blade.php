...
new class extends Component
{
    ...
    public function addProduct()
    {
        ...
        $this->reset(['temp_product_name', 'temp_product_category', 'temp_product_description', 'temp_product_price', 'temp_product_img']);
        $this->isImageUploaded = false;
        $this->imagePreviewUrl = null;
    ...
    /**
     * Clean up on component destroy (optional)
     */
    public function __destruct()
    {
        // Optional: Clean up preview folder when component is destroyed
        // Uncomment if you want to clean up when user leaves the page
        $this->cleanPreviewFolder();
    }
    ...
    {
       return Reservation::where('user_id', Auth::id())->latest()->first();
    }
    ...
    {
        return $this->view()->layout('layouts.app')->title("UCIC Student Business Corner | Reservasi Tenant");
    }
};
?>
                    ...
                    <div class="flex items-center w-full max-w-2xl">
                        ...
                        <div class="flex-1 text-center">
                            <div class="relative">
                                ...
                                <div class="absolute top-0 left-1/2 w-full h-0.5 bg-gray-300 -z-10 
                ...
                <div class="bg-orange-500 px-6 py-4">
                    ...
                    <p class="text-orange-100 text-sm mt-1">
                        ...
                        @elseif($currentStep == 2)
                            Isi informasi tentang toko Anda
                        @else
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea wire:model="description" rows="4"
                                    placeholder="Jelaskan tentang toko Anda, jenis makanan yang dijual, konsep, dll..."
                    ...
                    @if($currentStep == 3)
                        <div class="space-y-6">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <!-- Tombol Tambah Menu - disabled jika belum upload gambar -->
                                        ...
                                        @foreach($products as $index => $product)
                                            <div class="bg-white border border-gray-200 rounded-lg p-3 flex items-center justify-between hover:shadow-md transition">
                                                <div class="flex items-center gap-3 flex-1">
                                                    <!-- Show preview from temporary URL -->
